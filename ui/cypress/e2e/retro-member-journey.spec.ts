...
describe('Retro Member Journey', () => {
  ...
  it('Delete thought', () => {
    ...
    getRetroItemByMessage(thoughtToDelete).find(`[data-testid=columnItem-deleteButton]`).click();
  ...
  describe('Settings', () => {
    ...
    it('Account Tab: Log out', () => {
      ...
      const LoginPagePathWithTeamId = Cypress.config().baseUrl + getLoginPagePathWithTeamId(teamCredentials.teamId);
