...
describe('ColumnItemButtons', () => {
  ...
  describe('DeleteButton', () => {
    ...
    it('can be disabled', () => {
      ...
      const deleteButton = screen.getByTestId('trashIcon').parentElement;
  ...
  describe('CheckboxButton', () => {
    ...
    it('can be disabled', () => {
      render(<CheckboxButton checked={false} onClick={mockCheck} disabled={true} />);
      const checkboxButton = screen.getByTestId('checkbox').parentElement.parentElement;
