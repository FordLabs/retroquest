...
import {
  ...
  CancelButton,
  ConfirmButton,
} from '../components/column-item-buttons/ColumnItemButtons';
...
const Template: ComponentStory<typeof ColumnItemButtonGroup> = () => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <div className="retro-item" style={{ width: '500px', marginBottom: '20px' }}>
        <ColumnItemButtonGroup>
      ...
      <div className="retro-item" style={{ width: '500px', marginBottom: '20px' }}>
        <ColumnItemButtonGroup>
          <EditButton editing={false} onClick={() => alert('edit')} disabled={true} />
          <DeleteButton onClick={() => alert('delete')} disabled={true} />
          <CheckboxButton checked={false} onClick={() => alert('close')} disabled={true} />
          <CheckboxButton checked={true} onClick={() => alert('open')} disabled={true} />
        </ColumnItemButtonGroup>
      </div>
      ...
      <div className="retro-item" style={{ width: '500px', marginBottom: '20px' }}>
        <ColumnItemButtonGroup>
          ...
          <ConfirmButton onClick={() => alert('confirm')}>Conform</ConfirmButton>
        </ColumnItemButtonGroup>
      </div>
    </div>
  );
