...
export const getRetroPagePathWithTeamId = (teamId: string) =>
	`${TEAM_PAGE_ROOT}/${teamId}`;
export const getArchivesPagePathWithTeamId = (teamId: string) =>
	`${TEAM_PAGE_ROOT}/${teamId}/archives`;
export const getRadiatorPagePathWithTeamId = (teamId: string) =>
	`${TEAM_PAGE_ROOT}/${teamId}/radiator`;
